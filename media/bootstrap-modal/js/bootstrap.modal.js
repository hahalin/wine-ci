(function($) {
    ...
    var __m = {
        ...
        create:function(id){
            ...
            //o.width(opts.width);
            o.addClass('modal').addClass('fade').attr('role','dialog') ;//.addClass('tb_modal');
            ...
            var id_dialog=__m.guid();
            var dialog=$('<div class="modal-dialog"></div>').attr('id',id_dialog);
            dialog.appendTo(o);
            var content=$('<div class="modal-content"></div>').attr('id',__m.guid());
            ...
            $('#'+id).children('.modal-header').appendTo(content);
            $('#'+id).children('.modal-body').appendTo(content);
            $('#'+id).children('.modal-footer').appendTo(content);
