    ...
    addFieldToForm:function(field,pType){
        ...
        switch (ScrudCForm.elements[field].type){
            ...
            case 'textarea':
                ...
                break;
            case 'editor':
                ctl = $('<textarea id="preview_field_'+field+'_editor"></textarea>');
    ...
    changeFieldToForm:function(field){
        ...
        switch (ScrudCForm.elements[field].type){
            ...
            case 'editor':
                ...
                tinymce.init({
            	    selector: '#preview_field_'+field+'_editor',
            	    menubar: false,
            	    width:660,
            	    plugins: [
            	        "advlist autolink lists link image charmap print preview anchor",
...
$(document).ready(function(){
    ...
    $("#elements_preview >li>div>label").sortable({
    });
    $("#elements_preview div.control").sortable({
    });
