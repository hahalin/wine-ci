	...
	<!-- Additional styles -->
	<link rel="stylesheet" href="<?php echo base_url(); ?>assets/developer-admin/css/styles/agenda.css?v=1">
	<link rel="stylesheet" href="<?php echo base_url(); ?>assets/developer-admin/css/styles/dashboard.css?v=1">
	<link rel="stylesheet" href="<?php echo base_url(); ?>assets/developer-admin/css/styles/modal.css?v=1">
	<link rel="stylesheet" href="<?php echo base_url(); ?>assets/developer-admin/css/styles/progress-slider.css?v=1">
...
<body class="clearfix with-menu with-shortcuts">
		...
		<div class="with-padding">
			...
			<div class="columns">
				...
				<div class="twelve-columns twelve-columns-mobile new-row-mobile">
					...
					<table cellpadding="0" cellspacing="0" border="0" class="table responsive-table" id="exampletable" aria-describedby="example_info" width="100%" >
					<thead>
						<tr role="row"><th rowspan="2" class="sorting_asc" role="columnheader" tabindex="0" aria-controls="example" colspan="1" aria-sort="ascending" aria-label="Rendering engine: activate to sort column descending" style="width: 145px;">Rendering engine</th><th rowspan="2" class="sorting" role="columnheader" tabindex="0" aria-controls="example" colspan="1" aria-label="Browser: activate to sort column ascending" style="width: 149px;">Browser</th><th colspan="3" rowspan="1">Details</th></tr>
						<tr role="row"><th class="sorting" role="columnheader" tabindex="0" aria-controls="example" rowspan="1" colspan="1" aria-label="Platform(s): activate to sort column ascending" style="width: 190px;">Platform(s)</th><th class="sorting" role="columnheader" tabindex="0" aria-controls="example" rowspan="1" colspan="1" aria-label="Engine version: activate to sort column ascending" style="width: 125px;">Engine version</th><th class="sorting" role="columnheader" tabindex="0" aria-controls="example" rowspan="1" colspan="1" aria-label="CSS grade: activate to sort column ascending" style="width: 91px;">CSS grade</th></tr>
					</thead>
					<tfoot>
						<tr><th rowspan="2" colspan="1">Rendering engine</th><th rowspan="2" colspan="1">Browser</th><th rowspan="1" colspan="1">Platform(s)</th><th rowspan="1" colspan="1">Engine version</th><th rowspan="1" colspan="1">CSS grade</th></tr>
						<tr><th colspan="3" rowspan="1">Details</th></tr>
					</tfoot>
	...
	<script src="<?php echo base_url(); ?>assets/developer-admin/js/developr.progress - slider.js"></script>
	<script src="<?php echo base_url(); ?>assets/developer-admin/js/developr.tooltip.js"></script>
	<script src="<?php echo base_url(); ?>assets/developer-admin/js/developr.confirm.js"></script>
	<script src="<?php echo base_url(); ?>assets/developer-admin/js/developr.agenda.js"></script>
    <script src="<?php echo base_url(); ?>assets/developer-admin/js/developr.tabs.js"></script>		<!-- Must be loaded last -->

		<!-- Tinycon -->
		<script src="<?php echo base_url(); ?>assets/developer-admin/js/libs/tinycon.min.js"></script>
		<!-- Plugins -->
	...
	<script>
		...
		*/
		...
		var chartInit = false, drawVisitorsChart = function() {
			...
			//var raw_data = [['Website', 50, 73, 104, 129, 146, 176, 139, 149, 218, 194, 96, 53], ['Shop', 82, 77, 98, 94, 105, 81, 104, 104, 92, 83, 107, 91], ['Forum', 50, 39, 39, 41, 47, 49, 59, 59, 52, 64, 59, 51], ['Others', 45, 35, 35, 39, 53, 76, 56, 59, 48, 40, 48, 21]];
			var raw_data = [
				['date','BDI', 'BDI2', 'BCI', 'BCI2', 'BPI', 'BPI2', 'BSI', 'BSI2', 'BHSI', 'BHSI2', 'BDTI'],
				['Website', 50, 73, 104, 129, 146, 176, 139, 149, 218, 194, 96, 53]
			];
			//var months = ['date','BDI', 'BDI2', 'BCI', 'BCI2', 'BPI', 'BPI2', 'BSI', 'BSI2', 'BHSI', 'BHSI2', 'BDTI'];
			...
			*/
			...
			//var data2=raw_data;
			var raw_data2= google.visualization.arrayToDataTable([
				    [ 'idx','v'], 
        			[ 'BDI',10],
        			[ 'BDI2',20],    
        			[ 'BCI',30],
			...
			new google.visualization.ColumnChart(div.get(0)).draw( raw_data2,{
				//dataTable:raw_data,
				//title : '波羅的海指數',
				width : divWidth,
