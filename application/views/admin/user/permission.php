    ...
    $(document).ready(function(){
        ...
        $('#btn_save').click(function(){
            ...
            $.post('<?php echo base_url(); ?>index.php/admin/user/savePermission', {data:data}, function(html){
                var strAlertSuccess = '<div class="alert alert-success" style="position: fixed; right:50%; top:20px; -webkit-box-shadow: 0px 1px 0px rgba(255, 255, 255, 0.8) inset; -moz-box-shadow: 0px 1px 0px rgba(255, 255, 255, 0.8) inset; box-shadow: 0px 1px 0px rgba(255, 255, 255, 0.8) inset; display: none;">' +
