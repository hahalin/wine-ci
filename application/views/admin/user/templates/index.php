        ...
        <div class="container" style="border-bottom: 1px solid #CCC; padding-bottom:5px;padding-top:5px;
            ...
            <div style="text-align:right;width:100%;">
                ...
                <div class="btn-group" role="group">
                    ...
                    <a class="btn" onclick="searchModal();"><i class="glyphicon glyphicon-search"></i> <?php echo $lang->line('search');?></a>
                    <?php
    		        $q = $this->queryString;
    		        if (isset($q['xtype']))
    		            unset($q['xtype']);
                ...
                <?php if (!empty($this->results)) { ?>
                    <a class="btn"  onclick="crudExport();"><i class="glyphicon glyphicon-download"></i> <?php echo $CI->lang->line('export_csv');?></a>
                <?php } else { ?>
                    <a class="btn disabled"><i class="icon-download"></i> <?php echo $CI->lang->line('export_csv');?></a>
                <?php } ?>
                <a class="btn"  onclick="crudExportAll();"><i class="glyphicon glyphicon-download"></i> <?php echo $CI->lang->line('export_csv_all');?></a>
                <a type="button" class="btn btn-info" onclick="newRecord();"> <i class="glyphicon glyphicon-plus"></i> <?php echo $CI->lang->line('add'); ?></a>
            </div>
        </div>
    </div>
    </div>
