...
//<p class="message icon-speech grey-gradient small-margin-bottom">
//						<a href="#" title="Hide message" class="close">✕</a>
//						Message with close button
//					</p>
//$config['error_start_delimiter']   = '<p class="message icon-speech grey-gradient small-margin-bottom">';		// Error mesage start delimiter
